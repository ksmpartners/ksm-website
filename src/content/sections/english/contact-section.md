...
form:
  email_subject: "New form submission from ksmpartners.com" # Customized email subject (applicable when anyone submit form, form submission may receive by email depend on provider)
  submit_button:
  ...
  inputs:
    ...
    - note: deprecated # info | warning | success | deprecated | hint
      ...
      content: Something went wrong! please use this mail - [info@ksmpartners.com](mailto:info@ksmpartners.com) to get in touch!
---
